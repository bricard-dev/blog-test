...
export const carouselSlides: Article[] = [
  {
    id: 1,
    image: {
  ...
  },
  {
    ...
    date: "02 juin 2025",
    description:
      "Explorez la beauté préservée des forêts sévillanes à travers un sentier ombragé entre pins, chênes-lièges et parfums méditerranéens.",
  },
];
